...
id = 1; gap = []; minus2H = [];
filename{id} = 'Lewis B.O18.Na.EED.PM.txt'; gap(id) = 0; minus2H(id) = 0; id = id + 1; % 1
filename{id} = 'Lewis B.O18.Cs.EED.PM.txt'; gap(id) = 0; minus2H(id) = 0; id = id + 1; % 2
filename{id} = 'Lewis Y.O18.Na.EED.PM.txt'; gap(id) = 0; minus2H(id) = 0; id = id + 1; % 3
filename{id} = 'Lewis Y.O18.Cs.EED.PM.txt'; gap(id) = 0; minus2H(id) = 0; id = id + 1; % 4
filename{id} = 'LNFP 1.O18.Na.EED.PM.txt'; gap(id) = 0; minus2H(id) = 1; id = id + 1; % 5
filename{id} = 'LNFP 1.O18.Cs.EED.PM.txt'; gap(id) = 0; minus2H(id) = 1; id = id + 1; % 6
