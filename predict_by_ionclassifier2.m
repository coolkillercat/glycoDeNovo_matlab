function [results, ICScores] = predict_by_ionclassifier2( spectra, dataPeaks, dataVectors, icPool )
...
for s = 1 : num
    ...
    scores.B = zeros(1, size( dataVectors.B, 1 ));
    ...
    scores.C = zeros(1, size( dataVectors.C, 1 ));
    ...
    scores.Y = zeros(1, size( dataVectors.Y, 1 ));
    ...
    scores.Z = zeros(1, size( dataVectors.Z, 1 ));
    ...
    scores.O = zeros(1, size( dataVectors.O, 1 ));
