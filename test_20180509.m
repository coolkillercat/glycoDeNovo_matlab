...
datapath = 'D:\Projects\Glycomics\data\20180509\';
...
datapath = 'D:\Projects\Glycomics\data\20180509\';
spectraTrain = load_saved_spectra( '20170615.2' );
spectraTest = load_saved_spectra( '20180509' );
...
for k = 1 : length( spectraTest )
    ...
    spectraTest(k).save_reconstruction_full( [datapath, 'results/', name], [] );
end
