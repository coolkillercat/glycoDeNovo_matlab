clear filename;
if ismac
    datapath = [getenv('HOME'), '/Documents/Projects/Glycomics/data/', '20190116_FTMS', filesep];
else
    datapath = ['D:\Projects\Glycomics\data\', '20190116_FTMS', filesep];
end
...
%%
allspec = load_saved_spectra( '20190116_FTMS' );
