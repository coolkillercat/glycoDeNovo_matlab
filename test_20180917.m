%% 2018/09/04
clear filename;
datapath = ['D:', filesep, 'Projects', filesep, 'Glycomics', filesep, 'data', filesep, '20180917', filesep];
id = 1; gap = []; minus2H = [];
filename{id} = 'Unknow_man4_1.txt'; gap(id) = 0; minus2H(id) = 0; id = id + 1; % 1
filename{id} = 'Unknow_man4_2.txt'; gap(id) = 0; minus2H(id) = 0; id = id + 1; % 1
...
spectraTest = load_saved_spectra( '20180917' );
