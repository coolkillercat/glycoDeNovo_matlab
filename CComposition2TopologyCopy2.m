classdef CComposition2TopologyCopy2 < handle % By Pengyu Hong @ Brandeis University
    properties
        mMaxNumberBranches;
    end
    ...
    methods
        function this = CComposition2TopologyCopy2()
                                ...
                                for n6 = 0 : composition(6)
                                    ...
                                    for n7 = 0 : composition(7)
                                        ...
                                        for n8 = 0 : composition(8)
                                            ...
                                            %{
                                            if this.mMap_BisectCompositions.isKey( key1 )
                                                branch2key = this.mMap_BisectCompositions( key1 );
                                                if any(branch2key == key2)
                                                    continue;
                                                else
                                                    this.mMap_BisectCompositions( key1 ) = [branch2key, key2]; % Record it.
                                                end
                                            else
                                                this.mMap_BisectCompositions( key1 ) = key2; % Record it.
                                            end
                                            %}
